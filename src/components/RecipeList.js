...
// Importation des images des recettes par défaut
...
const defaultRecipes = [
  {
    ...
    calories: 400,
    ingredients: ['200g de spaghetti', '100g de lardons', '2 œufs', '50g de parmesan', 'Sel et poivre'],
  ...
  },
  {
    ...
    calories: 300,
    ingredients: ['1 romaine', '100g de poulet grillé', '30g de parmesan', 'Croutons', 'Sauce César'],
  ...
  },
  {
    ...
    calories: 600,
    ingredients: ['1 pâte à pizza', '200g de tomate', '150g de mozzarella', 'Basilic frais', 'Huile d\'olive'],
  ...
  },
  {
    ...
    calories: 70,
    ingredients: ['100g de concombre', '100g de tomates cerise'],
...
function RecipeList() {
  ...
  useEffect(() => {
    // Charger les recettes depuis l'API et ajouter les recettes par défaut
    const fetchRecipes = async () => {
      try {
        ...
        if (Array.isArray(apiRecipes)) {
          // Fusionner les recettes par défaut avec celles de l'API
          setRecipes([...defaultRecipes, ...apiRecipes]);
        } else {
          console.error('Les données chargées ne sont pas un tableau. Utilisation uniquement des recettes par défaut.');
